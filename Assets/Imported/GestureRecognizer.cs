...
public class GestureRecognizer : MonoBehaviour
{
    ...
    public MarchingLane[] marchingLanes;
    ...
    private void EndGesture()
    {
        ...
        else
        {
            ...
            {
                foreach (MarchingLane lane in marchingLanes)
                {
                    lane.OnGestureEnd(m.GetName());
                }
            }
        }
        varReset();
    ...
    private DrawnGesture FindMatch(DrawnGesture playerGesture, GestureTemplates templates)
    {
        ...
        Debug.Log("Match: " + match.GetName() + " with average difference: " + minAvgDifference);
        return match;
    }
